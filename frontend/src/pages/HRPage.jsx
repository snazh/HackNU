...
const dummyCandidates = [
  {
    ...
    salary: "2000$",
    relevance: 85,
    summary: "Отличные навыки фронтенда, соответствует опыту",
    chat: [
      { text: "Я заинтересована в вакансии", fromUser: true },
      { text: "Спасибо за отклик! Мы свяжемся с вами.", fromUser: false },
    ],
  },
  {
    id: 2,
    ...
    salary: "1500$",
    relevance: 60,
    summary: "Нужны дополнительные навыки, опыт небольшой",
    chat: [],
  },
    ...
    <div className="min-h-screen flex bg-gray-100 p-8 space-x-6">
      ...
      {selectedCandidate && (
        <div className="flex-1 bg-white shadow-md rounded-2xl p-6 flex flex-col">
          ...
          <p className="mb-4 text-gray-700 font-medium">Причины релевантности: {selectedCandidate.summary}</p>
